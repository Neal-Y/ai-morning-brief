...
>
> This doc's own F5 quiz plan (§ below: "quiz 蓋在 Library 上，配退場條件") was itself overridden by later events — quiz shipped as a fully independent pipeline regardless of the Library-usage precondition described here. Kept for the product-philosophy rationale (Hooked Model / retention research) and the Rejected-features table, which are still good reference even though the roadmap sequencing is stale.
>
> For current product state see [../../CLAUDE.md](../../CLAUDE.md). Related: [2026-04-26-product-review.md](./2026-04-26-product-review.md) (the pivot memo that revised this doc's F5 priority — later itself superseded, see [../PRINCIPLES.md](../PRINCIPLES.md) for the durable methodology extracted from it).
>
> **Baseline**: [2026-04-13-v1-proposal.md](./2026-04-13-v1-proposal.md) (V1, superseded by this doc at the time).
...
- 詳細設計提案見 [2026-04-26-library-proposal.md](./2026-04-26-library-proposal.md)
...
| Provider alternation v2（exploration slot, 時間衰減）| 連 baseline 都還沒量過就在規劃 v2，過早優化（[PRODUCT_REVIEW](./2026-04-26-product-review.md) §「先量再優化」） |
...
- 產出：[2026-04-26-product-review.md](./2026-04-26-product-review.md)（覆盤紀錄 + 工作原則）+ [2026-04-26-library-proposal.md](./2026-04-26-library-proposal.md)（設計提案）
